...
#####utilize the subset function from "caTools". SplitRatio = percentage of the original data you want in your training set
...
#Let's check some values best off our model:
