...
# Method 1: A plot of the total within-groups sums of squares against the number of clusters
# in a K-means solution can be helpful. A bend in the graph can suggest the appropriate number of clusters. 
